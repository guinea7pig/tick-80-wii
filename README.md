...
**TIC-80 TINY COMPUTER** - [https://tic80.com](https://tic80.com) Check out the original version and download a offaicail build here
...
# Contributing1
**wwe are working on sprate page for bugs in this port**
