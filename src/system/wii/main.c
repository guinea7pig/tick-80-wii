...
int kbdfd = kbdinit();
    ...
    int kbdfd = kbdinit();
    char chars[12] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_i;

    int kbdfd = kbdinit();
    char chars[13] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_j;
  
    int kbdfd = kbdinit();
    char chars[14] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_k;

    int kbdfd = kbdinit();
    char chars[15] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_l;


    int kbdfd = kbdinit();
    char chars[16] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_m:


    int kbdfd = kbdinit();
    char chars[17] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_n;


        int kbdfd = kbdinit();
    char chars[18] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_o;


    int kbdfd = kbdinit();
    char chars[19] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_p;



    int kbdfd = kbdinit();
    char chars[20] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_q;


    int kbdfd = kbdinit();
    char chars[21] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_r;


    int kbdfd = kbdinit();
    char chars[22] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_s;


    int kbdfd = kbdinit();
    char chars[23] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_t;
    ...
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_u;



    int kbdfd = kbdinit();
    char chars[25] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_v;

    int kbdfd = kbdinit();
    char chars[26] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_w;

    int kbdfd = kbdinit();
    char chars[27] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_x;

    int kbdfd = kbdinit();
    char chars[28] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
...
//speacail keys 
       int kbdfd = kbdinit();
    char chars[40] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_return;
    
      int kbdfd = kbdinit();
    char chars[41] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_escape;

      int kbdfd = kbdinit();
    char chars[42] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_backspace;

         int kbdfd = kbdinit();
    char chars[43] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_tab;

         int kbdfd = kbdinit();
    char chars[44] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_7;//have no idea what its supposed to mean

//symbols
         int kbdfd = kbdinit();
    char chars[45] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_minus;

         int kbdfd = kbdinit();
    char chars[46] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_equals;

         int kbdfd = kbdinit();
    char chars[47] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_rightbracket;

         int kbdfd = kbdinit();
    char chars[48] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_leftbracket;
    
         int kbdfd = kbdinit();
    char chars[51] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_semicolon;

        int kbdfd = kbdinit();
    char chars[52] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_apostrophe;


        int kbdfd = kbdinit();
    char chars[53] = kbdscan(kbdfd);
    char* pressed = kbdhandle(kbdfd, chars, false);
    kbddenit(kbdfd);
    return *pressed=tic_key_period;
